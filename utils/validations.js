...
const validateARecord = (type) =>
  and([R.propIs(Array, type), R.propSatisfies(withLengthGte(1), type)]);
...
const validateDomainData = validate({
  name: {
    reason:
      "The name of the file is invalid. It must be lowercased, alphanumeric and each component must be more than 2 characters long",
    fn: or([
      R.equals("@"),
      and([
        R.is(String),
  ...
  record: {
    reason:
      "Invalid record. CNAME records have to be a host name and A records has to be a list of IP addresses.",
    fn: and([
      R.is(Object),
