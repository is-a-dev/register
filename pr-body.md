...
https://satva-urls-nine.vercel.app
<!-- WEBSITE_PREVIEW_END -->
# Website Purpose
<!-- Please tell us the purpose or motive behind your website. For example, it is a portfolio website, etc. -->
<!-- WEBSITE_PURPOSE_START -->
This is a URL shortener tool I built to create and manage shortened links. I'm hosting it under this subdomain for personal, non-commercial use.
<!-- WEBSITE_PURPOSE_END -->